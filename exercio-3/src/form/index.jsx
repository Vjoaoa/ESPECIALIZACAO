...
import getCursos from "../requests/curso";
import { editarAluno, saveAluno } from "../requests/requests";
...
export default function Form(props) {
  ...
  return (
    <div className="form">
      ...
      <button className="bnt" onClick={formData.id ? edit : save}>Salvar</button>
    </div>
  );
}